...
namespace TSP.Funcs.Repos
{
    public class BaseRepo
    {
        ...
        public virtual async Task<IEnumerable<M>> GetAll<T, M>(int page=1,int size=20,string keyword = "") where T : BaseEntity where M : BaseModel
        {
